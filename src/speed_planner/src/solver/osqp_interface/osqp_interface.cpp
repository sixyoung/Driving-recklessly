...
namespace osqp
{
    ...
    std::tuple<std::vector<double>, std::vector<double>, int, int, std::string> OSQPInterface::solve()
    {
        // Solve Problem
        osqp_solve(work.get());
        ...
        // Solver textual status (e.g., "solved", "primal infeasible", etc.)
        std::string status_message(work->info->status);
        // Result tuple
        std::tuple<std::vector<double>, std::vector<double>, int, int, std::string> result =
                std::make_tuple(sol_primal, sol_lagrange_multiplier, status_polish, status_solution, status_message);
    ...
    std::tuple<std::vector<double>, std::vector<double>, int, int, std::string> OSQPInterface::optimize()
    {
        // Run the solver on the stored problem representation.
        std::tuple<std::vector<double>, std::vector<double>, int, int, std::string> result = solve();
        return result;
    }
