...
{
public:
  QpSplinePathGenerator(Spline1dSolver *spline_solver, const ReferenceLine &reference_line, const Param_Configs &cfg);
...
private:
  ...
  const FrenetFramePath *last_frennet_path_ = nullptr;
