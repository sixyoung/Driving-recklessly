...
{
public:
  DpPolyPathOptimizer(const Param_Configs& cfg);
  DpPolyPathOptimizer(const std::vector<const Obstacle*>& obstacles, const nav_msgs::Odometry& vehicle_pos, const Param_Configs& cfg);
  ~DpPolyPathOptimizer();
