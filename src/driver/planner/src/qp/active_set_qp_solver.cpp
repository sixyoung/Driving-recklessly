...
ActiveSetQpSolver::ActiveSetQpSolver(const Eigen::MatrixXd &kernel_matrix, const Eigen::MatrixXd &offset,
    ...
    : QpSolver(kernel_matrix, offset, affine_inequality_matrix, affine_inequality_boundary, affine_equality_matrix, affine_equality_boundary),
      Config_(&cfg),
      num_constraint_(static_cast<int>(affine_equality_matrix_.rows() + affine_inequality_matrix_.rows())), 
      num_param_(static_cast<int>(kernel_matrix.rows())), qp_eps_num_(Config_->default_active_set_eps_num), 
      qp_eps_den_(Config_->default_active_set_eps_den), qp_eps_iter_ref_(Config_->default_active_set_eps_iter_ref), 
